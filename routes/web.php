...
use App\Http\Controllers\PhysicaltargetController;
...
Route::group(['middleware' => ['get.menu']], function () {
    Route::get('/', function () {           return view('dashboard.widgets'); });

    Route::group(['middleware' => ['role:user']], function () {

        /*PWD APP ROUTES*/
        Route::get('/home', function () {     return view('dashboard.widgets'); });
        
        
        Route::resource('implementors', 'ImplementorController');
        Route::resource('projects','ProjectController');
        Route::resource('budgets','BudgetController');
        Route::resource('physicalprogresses','PhysicalprogressController');
        Route::resource('physicaltargets','PhysicaltargetController');
        Route::resource('financialprogresses','FinancialprogressController');
        Route::resource('financialtargets','FinancialtargetController');

        
        // Route::get('/implementor', function () {     return view('implementors.index'); });
        // Route::get('/project', function () {     return view('projects.index'); });
        // Route::get('/budget', function () {     return view('budgets.index'); });
        // Route::get('/physicalprogress', function () {     return view('physicalprogresses.index'); });
        // Route::get('/physicaltarget', function () {     return view('physicaltargets.index'); });
        // Route::get('/financialprogress', function () {     return view('financialprogresses.index'); });
        // Route::get('/financialtarget', function () {     return view('financialtargets.index'); });


        /*END of PWD APP ROUTES*/
